...
import { Award, Calendar, DollarSign, MessageCircle, Star, User } from "lucide-react";
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-muted-foreground">
                  {trainer.yearsExperience} years exp.
                </span>
                ...
                <div className="mb-4 flex items-start gap-4">
                  <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-full bg-secondary">
                    {selectedTrainer.profilePhoto ? (
                      <img
                        src={selectedTrainer.profilePhoto}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-muted-foreground">
                          ({selectedTrainer.totalRatings} reviews)
                        </span>
                      </div>
                    </div>
                ...
                <div className="rounded-lg border bg-secondary/30 p-4 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">
                      {selectedTrainer.yearsExperience} years
                    </span>
                  </div>
