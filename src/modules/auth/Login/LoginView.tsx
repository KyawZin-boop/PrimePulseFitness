...
const LoginView = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      <div className="w-full flex items-center justify-center p-5 shadow-lg mb-3">
        <p className="text-2xl font-light">Smart Space</p>
      </div>
      <div className="h-full flex flex-col items-center justify-center gap-5">
        <h1 className="text-3xl font-light">Welcome Back!</h1>
        <p className="text-lg">Sign in to your Smart Space Account</p>
        <GoogleLogin
